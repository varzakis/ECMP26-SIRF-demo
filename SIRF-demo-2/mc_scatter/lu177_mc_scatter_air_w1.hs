...
!name of data file := lu177_mc_scatter_air_w1.a00
;patient name := SMC_lu177_mc_scatter_air_w1.a00
;!study ID := lu177_mc_scatter
...
maximum pixel count := 1060.773560
;# total counts := 118399.349423
;# Center of Rotation := 65.000000

!SPECT STUDY (acquired data) :=
orbit := non-circular
;# Non-Uniform Orbit File := lu177_mc_scatter.cor
...
;# Total activity (MBq) in the slices := 11110.000000
;# Collimator := ge-megp
