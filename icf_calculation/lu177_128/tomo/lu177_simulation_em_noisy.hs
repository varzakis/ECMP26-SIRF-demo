...
!name of data file := lu177_simulation_em_noisy.s
;patient name := lu177_simulation_em_noisy.s
;!study ID := lu177_simulation_em_noisy
...
maximum pixel count := 15.025345
;# total counts := 15960.894207
